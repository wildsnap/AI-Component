# pip install mlflow tensorflow numpy matplotlib seaborn scikit-learn pillow
...
for name, backbone in backbones.items():
    ...
    # base_model = backbone(include_top=False, weights="./mobilenet_v2_weights.h5", input_shape=(IMG_SIZE[0], IMG_SIZE[1], 3))
